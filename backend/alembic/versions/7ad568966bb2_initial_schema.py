...
Revision ID: 7ad568966bb2
Revises: 
Create Date: 2026-07-27 02:08:38.811595
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_chat_sessions_repository_id'),
        'chat_sessions',
        ['repository_id'],
        unique=False
    )
